...
//get signup form data if signup is clicked
if(isset($_POST['submit'])) {
     ...
     // redirect back to the signup page if there was a problem
     if (isset($_SESSION['signup'])) {
        //pass form date back to signup page
       ...
       if(!mysqli_errno($connection)) {
        ...
        $_SESSION['signup-success'] = "Registeration sucsessful. Please log in";
